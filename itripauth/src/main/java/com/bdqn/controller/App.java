 ...
 */
public class App {
    public static String account = "2966824089@qq.com";            //替换为发件人账号
    public static String password = "g123x123";                    //替换为发件人账号密码

    public static String receiveMailAccount = "";    //替换为收件人账号

    public static void SenEmail(String email ,String code) throws Exception {
    ...
    public static MimeMessage createMimeMessage(String code,Session session, String sendMail, String receiveMail)
        ...
        // 5. Content: 邮件正文
        message.setContent("用户你好当前激活码为"+code, "text/html;charset=UTF-8");
        // 6. 设置发件时间
